...
module.exports = {
  ...
  async up(queryInterface) {
    ...
    await queryInterface.bulkInsert('roles', [
      ...
      { id: getId('Subscriber'), name: 'Subscriber', createdAt, updatedAt },

      { id: getId('TrialUser'), name: 'TrialUser', createdAt, updatedAt },

      { id: getId('SupportAgent'), name: 'SupportAgent', createdAt, updatedAt },
    ]);
