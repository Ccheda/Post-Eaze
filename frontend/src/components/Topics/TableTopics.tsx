...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/topics/topicsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureTopicsCols';
...
const TableSampleTopics = ({
  ...
  useEffect(() => {
    if (topicsNotify.showNotification) {
      notify(topicsNotify.typeNotification, topicsNotify.textNotification);
    }
  }, [topicsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/topics/topics-view/?id=${id}`);
  };
  ...
  return (
    <>
      ...
      {topics && Array.isArray(topics) && !showGrid && (
        <ListTopics
          topics={topics}
          loading={loading}
...
export default TableSampleTopics;
